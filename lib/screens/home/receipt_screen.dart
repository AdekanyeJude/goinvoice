// lib/screens/home/receipt_screen.dart
import 'dart:io';
  ...
  Future<void> _downloadReceipt(context) async {
    await screenshotController
      ...
      if (image != null) {
        ...
        final imagePath = '${directory.path}/receipt_${widget.invoice.id}.png';
        await File(imagePath).writeAsBytes(image);
        ScaffoldMessenger.of(context)
            .showSnackBar(SnackBar(content: Text('Saved: $imagePath')));
      }
    });
  }
      ...
      body: ListView(
        children: [
          Screenshot(
            ...
            child: /* reuse same content structure as InvoiceScreen but compact for receipt */
                Container(
              ...
              child: Column(
                children: [
                  ...
                  Align(
                      ...
                      child: outfitFonttxt('Bill to: ${inv.customerName}', 14.0,
                          FontWeight.w500, colorCodes.eerieBlack)),
                  heightsizedBox(6.0),
                  Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        outfitFonttxt('${inv.dialCode}${inv.customerPhone}',
                            14.0, FontWeight.w400, colorCodes.eerieBlack),
                        Column(children: [
                          dmSanstxt('Class', 14.0, FontWeight.w500,
                              colorCodes.background),
                          outfitFonttxt(inv.studentClass, 14.0, FontWeight.w400,
                  ...
                  Container(
                    ...
                    child: Column(children: [
                      Container(height: 3, color: colorCodes.paleRed),
                      Padding(
                      ...
                      Padding(
                        ...
                        child: Column(children: [
                          ...
                          heightsizedBox(8.0),
                          rowTable2('', '', '', 'Total', inv.total),
                          rowTable2('', '', '', 'Paid', inv.totalPaid,
                              color: colorCodes.shamRockGreen),
                          rowTable2('', '', '', 'Balance', inv.balance,
                  ...
                  Row(children: [
                    SizedBox(
                        width: 120,
                        child: authbtn(
                            'Download', () => _downloadReceipt(context))),
                    widthsizedBox(10.0),
                    SizedBox(
                        width: 120,
                        child: authbtn('Share', () => _shareReceipt())),
                  ])
                ],
              ),
            ),
...
//     file.writeAsBytes(bytes); //xpressReceipt
//   }
...
//                                   crossAxisAlignment: CrossAxisAlignment.end,
//                                   children: [
//                                     dmSanstxt('Invoice #${widget.id}', 14.0,
//                                         FontWeight.w500, colorCodes.eerieBlack),
//                                     Text(
//                                       '${widget.date}',
//                                       style: TextStyle(
...
//                   heightsizedBox(18.0),
//                   Container(
//                     height: (widget.itemTwo == '')
//                         ? 270
//                         : null, // MediaQuery.of(context).size.height / 4,
//                     width: MediaQuery.of(context).size.width,
...
//                               crossAxisAlignment: CrossAxisAlignment.start,
//                               children: [
//                                 dmSanstxt('Due date: ', 16.0, FontWeight.w500,
//                                     colorCodes.onyx),
//                                 dmSanstxt('${widget.dueDate} ', 16.0,
...
//                               crossAxisAlignment: CrossAxisAlignment.start,
//                               children: [
//                                 dmSanstxt('Contact Info:  ', 16.0,
//                                     FontWeight.w500, colorCodes.onyx),
//                                 dmSanstxt('+2348109919966', 16.0,
//                                     FontWeight.w500, colorCodes.onyx),
//                               ],
//                             ),
//                           ),
