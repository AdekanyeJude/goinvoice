// lib/screens/home/invoice_screen.dart
import 'dart:io';
...
class _InvoiceScreenState extends State<InvoiceScreen> {
  ...
  Future<void> _downloadReceipt(context) async {
    await screenshotController
      ...
      if (image != null) {
        ...
        final imagePath = '${directory.path}/image_${widget.invoice.id}.png';
        await File(imagePath).writeAsBytes(image);
        showToast("Saved to $imagePath", context);
      }
    });
  }
  ...
  Future saveImage(Uint8List bytes) async {
    ...
    File file =
        File('${appStorage.path}/xpressReceipt_${widget.invoice.id}.png');
  ...
  void initState() {
    super.initState();
    invoiceNum = StorageService.generateNextInvoiceNumber();
  }
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    outfitFonttxt(
                                        "PhoneNo: ${inv.dialCode}${inv.customerPhone}",
                                        14.0,
                                        FontWeight.w400,
                                        colorCodes.eerieBlack),
                                    Column(
                    ...
                    child: Column(
                      children: [
                        Container(
                            height: 3,
                            decoration:
                                BoxDecoration(color: colorCodes.paleRed)),
                        Padding(
  ...
  void showToast(String msg, BuildContext context) {
    // reuse your app toast util or simple snackbar
