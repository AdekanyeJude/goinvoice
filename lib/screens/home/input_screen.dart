...
class _InvoiceInputScreenState extends State<InvoiceInputScreen> {
  ...
  TextEditingController accountNumController =
      TextEditingController(text: '2034372892');
  ...
  TextEditingController bankcontroller =
      TextEditingController(text: 'FIRSTBANK OF NIGERIA');
  ...
  void initState() {
    ...
    setState(() {
      // currentIndex;
      bankcontroller.text = bankcontroller.text;
      accountNumController.text = accountNumController.text;
      ...
      priceSixController.addListener(() {
        setState(() {
          if (!isUpdating) {
            setState(() {
              isUpdating = true;
              ...
              amountSixController.text =
                  (amountValue * double.parse(quantitySixController.text))
                      .toString();
              totalController.text =
                  (double.parse(amountPaidOneController.text) +
                          double.parse(amountPaidTwoController.text) +
                          double.parse(amountPaidThreeController.text) +
                          double.parse(amountPaidFourController.text) +
                          double.parse(amountPaidFiveController.text) +
                          double.parse(amountSixController.text))
                      .toString();
              isUpdating = false;
            });
          }
      ...
      priceSevenController.addListener(() {
        if (!isUpdating) {
          setState(() {
            isUpdating = true;
            double amountValue =
            ...
            amountPaidSevenController.text =
                (amountValue * double.parse(quantitySevenController.text))
                    .toString();
            totalController.text = (double.parse(amountPaidOneController.text) +
                    double.parse(amountPaidTwoController.text) +
                    double.parse(amountPaidThreeController.text) +
                    ...
                    double.parse(amountPaidFiveController.text) +
                    double.parse(amountSixController.text) +
                    double.parse(amountPaidSevenController.text))
                .toString();
            isUpdating = false;
          });
        }
      });
      priceEightController.addListener(() {
        if (!isUpdating) {
          setState(() {
            isUpdating = true;
            double amountValue =
            ...
            amountPaidEightController.text =
                (amountValue * double.parse(quantityEightController.text))
                    .toString();
            totalController.text = (double.parse(amountPaidOneController.text) +
                    double.parse(amountPaidTwoController.text) +
                    double.parse(amountPaidThreeController.text) +
                    ...
                    double.parse(amountSixController.text) +
                    double.parse(amountPaidSevenController.text) +
                    double.parse(amountPaidEightController.text))
                .toString();
            isUpdating = false;
          });
        }
      });
      priceNineController.addListener(() {
        if (!isUpdating) {
          setState(() {
            isUpdating = true;
            double amountValue =
            ...
            amountPaidNineController.text =
                (amountValue * double.parse(quantityNineController.text))
                    .toString();
            totalController.text = (double.parse(amountPaidOneController.text) +
                    double.parse(amountPaidTwoController.text) +
                    double.parse(amountPaidThreeController.text) +
                    ...
                    double.parse(amountPaidSevenController.text) +
                    double.parse(amountPaidEightController.text) +
                    double.parse(amountPaidNineController.text))
                .toString();
            isUpdating = false;
          });
        }
      });
      priceTenController.addListener(() {
        if (!isUpdating) {
          setState(() {
            isUpdating = true;
            double amountValue =
            ...
            amountPaidTenController.text =
                (amountValue * double.parse(quantityTenController.text))
                    .toString();
            totalController.text = (double.parse(amountPaidOneController.text) +
                    double.parse(amountPaidTwoController.text) +
                    double.parse(amountPaidThreeController.text) +
                    ...
                    double.parse(amountPaidEightController.text) +
                    double.parse(amountPaidNineController.text) +
                    double.parse(amountPaidTenController.text))
                .toString();
...
// final Invoice invoice;
  ...
  String companyAcctName = 'CHRISTFIELD INTERNATIONAL SCHOOLS ADO - EKITI';
                      ...
                      Row(
                        ...
                        children: [
                          SizedBox(
                            ...
                            // nametextField(
                            //     'Session', '2023/2024', sessionTextController,
                            //     key: TextInputType.numberWithOptions()),
                          ),
                          SizedBox(
                            width: 160,
                            child: selectDropdown(
                        ...
                        children: [
                          Expanded(
                            ...
                            children: [
                              ...
                              SizedBox(
                                  width: 195,
                                  child: itemField('', bankcontroller,
                                      onchanged: (value) {
                                    setState(() {
                  ...
                  SizedBox(
                    ...
                    child: authbtn('Generate\nInvoice', () async {
                      if (customernameTextController.text.isEmpty ||
                          ...
                          // classTextController.text.isEmpty ||
